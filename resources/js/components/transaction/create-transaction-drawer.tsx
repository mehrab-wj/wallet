...
interface CreateTransactionsDrawerProps {
    open: boolean;
...
export default function CreateTransactionsDrawer({ open, onOpenChange, accounts, categories }: CreateTransactionsDrawerProps) {
    ...
    return (
        <Drawer open={open} onOpenChange={onOpenChange}>
            <DrawerContent>
                <Form className="overflow-y-auto" method="post" action={route('transactions.store')} onSuccess={handleSuccess} resetOnSuccess>
                    {({ processing, errors }) => (
                        <>
                            <DrawerHeader>
