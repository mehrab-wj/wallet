                ...
                {CURRENCIES.map((currency) => (
                    <SelectItem key={currency.code} value={currency.code}>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="hidden text-muted-foreground sm:block">{currency.name}</span>
                            <span className="ml-auto hidden text-muted-foreground sm:block">{currency.symbol}</span>
                        </div>
                    </SelectItem>
                ))}
            </SelectContent>
