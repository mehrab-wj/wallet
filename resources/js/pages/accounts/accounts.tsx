            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    ...
                    <Drawer open={isCreateDrawerOpen} onOpenChange={setIsCreateDrawerOpen}>
                        ...
                        <DrawerContent>
                            <Form method="post" action={route('accounts.store')} onSuccess={resetCreateDrawer} resetOnSuccess>
                                {({ processing, errors }) => (
                                    <>
                                        <DrawerHeader>
                                        ...
                                        <div className="space-y-4 px-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <CurrencySelect name="currency" placeholder="Select currency..." disabled={processing} required />
                ...
                {accounts.length === 0 ? (
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-12">
                            ...
                            <CardTitle className="mb-2 text-center">No accounts yet</CardTitle>
                            <CardDescription className="mb-4 text-center">Create your first account to start tracking your finances</CardDescription>
                            <Drawer open={isCreateDrawerOpen} onOpenChange={setIsCreateDrawerOpen}>
                                <DrawerTrigger asChild>
                                    <Button>
                                        <Plus className="h-4 w-4" />
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {accounts.map((account) => (
                            <Card key={account.id}>
                                ...
                                <CardContent>
                                    <div className="text-sm text-muted-foreground">Created {new Date(account.created_at).toLocaleDateString()}</div>
                                </CardContent>
                            </Card>
                        ))}
                    </div>
                ...
                <Drawer open={isEditDrawerOpen} onOpenChange={setIsEditDrawerOpen}>
                    <DrawerContent>
                        {editingAccount && (
                            <Form method="put" action={route('accounts.update', editingAccount.id)} onSuccess={resetEditDrawer}>
                                {({ processing, errors }) => (
                                    <>
                                        <DrawerHeader>
                                            <DrawerTitle>Edit Account</DrawerTitle>
                                            <DrawerDescription>Update your account information</DrawerDescription>
                                        </DrawerHeader>
